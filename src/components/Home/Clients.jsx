...
const Clients = () => {
  ...
  return (
    <div className=" w-full max-w-8xl mx-auto p-4 bg-black shadow-lg  ">
      <div className="text-center mt-4 flex justify-center items-center p-4">
        <h1 className="text-transparent bg-clip-text bg-gradient-to-r from-bronze-start to-bronze-end text-4xl font-bold">Our Clients</h1>
      </div>
